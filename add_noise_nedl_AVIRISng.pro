...
image_name ='sensitivity_analysis_4_alb50_ch4_25_102_by_100_AVIRISng'
NEdL_coef_C_file = img_folder + 'NG_fit_params.txt'
img_orig = img_folder + image_name

out_folder = 'F:\Sensitivity_Analysis_20141212\add_noise_out\sensitivity_analysis\'
out_name = image_name+'_noise_nedl_2'
